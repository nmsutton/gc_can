...
////
float m1 = 0.370*0.8*7.63*0.5;//.365;//.5;//0.8746922984;//*0.5;//1.0;//0.6;//0.5;//0.6;//0.42;//1.1;//0.5;//0.366;//0.45;//0.6;//0.45;//0.366;//0.42;//;10;//0.42;//;//*3;//*0.42;//*1.320675526;//1;//1.89;//1.5;//1.2;//1;//1.2;
