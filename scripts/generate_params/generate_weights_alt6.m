...
r_s=0.8*.9;%.9;%.9;%1;%0.8*1.1;%.9;%1;%1.1;%1;%.9;%.8;%.8;%1.01;%1.05;%1.1;%0.9;%1.1;%1;%10/42;%20/42;%1; % ring scale
p1=.54;%.52;%.54;%.7;%.76;%.68;%.54;%.6;%.68;%.54;%.5;%.54;%.68;%.54;%.58;%.62;%.68;%10;%20;%.68;%20;%20;%.68;
p2=2;p3=2;
% center size
