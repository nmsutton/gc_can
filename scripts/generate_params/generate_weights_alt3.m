...
r_s=20/42;%25/42;%40/42;%0.8*1.1;%*1.4;%1.5;%0.73;%1.1;%(36/42);%1;%(42/30); % ring scale
p1=20;%.68;
p2=2;p3=2;
% center size
p4=r_s*90;%50;%35;%60;%90;%r_s*52;%35;%45;%52;%40;%70;%130;%38;%*2.5*1.3;%.55;%.7;%4;%2;%2;%2.5;%2;%*1.4;%1.344;%*2.7*(14/20);%1.4;%*.5; 
% center size
p8=r_s*70;%140;%230;%140;%100;%30;%r_s*.135*1.02;%1.07;%1;%.87;%.135*.9;%1;%.97;%.99;%.11;%.13;%.12;%.14;%.12;%.22;%.2;%.25;%.135; 
% surround size
