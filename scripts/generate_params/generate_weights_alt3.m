...
p1=.68;p2=2;p3=2;
p4=38*2;%2.5;%2;%*1.4;%1.344;%*2.7*(14/20);%1.4;%*.5; % center size
p5=p3;p6=p4;
p7=0.15*3;%.7;%.9;%.7;%0.174*1.4;%*2.4*(14/20);%1.4;%*.75;%0.15; % surround size
p8=.25;%.135;
p9=2;p10=2;p11=2;p12=p4;p13=p11;p14=p11;p15=p12;
p16=0.81*3;%.7;%.9;%.7;%0.9396*1.4*.9;%*3*(14/20);%1.4;%*.75;%0.81; % surround size
p17=0.0058;
