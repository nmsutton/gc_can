...
p1=.68;p2=2;p3=2;
% center size
p4=70;%130;%38;%*2.5*1.3;%.55;%.7;%4;%2;%2;%2.5;%2;%*1.4;%1.344;%*2.7*(14/20);%1.4;%*.5; 
p5=p3;p6=p4;
% surround size
p7=0.2;%0.2;%*1.1*.97;%1.04;%1.05;%1.15;%1;%4;%.7;%.9;%.7;%0.174*1.4;%*2.4*(14/20);%1.4;%*.75;%0.15; 
% center size
p8=.135*.99;%.11;%.13;%.12;%.14;%.12;%.22;%.2;%.25;%.135; 
p9=2;p10=2;p11=2;p12=p4;p13=p11;p14=p11;p15=p12;
% surround size
p16=1.08*.99;%0.81;%*1.1*.97;%1.04;%1.05;%1.15;%1;%4;%.7;%.9;%.7;%0.9396*1.4*.9;%*3*(14/20);%1.4;%*.75;%0.81; 
p17=0.0058;
