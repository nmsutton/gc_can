...
% y_srt = 5;
create_plot = 1;
% stat reporting seems to have bugs so it is commented out below
% report_stats = 1; 
...
% cent_x=[0, -7,   7, -14, 14, 7, -7,   20, -20];
% cent_y=[0, -10, 10,  0,  0, -10, 10, -10, 10];
% cent_x=[0, -4,   4, -12, 12,  8,  -8,   4, -4, 16, -16];
% cent_y=[0, -8,   8,  -2,  2, -8,   8, -16, 16, 12,  -12];
% cent_x=[0, -6,   6, -10, 10,  6,  -6,  16, -16, -16, 16];
% cent_y=[0, -8,   8,   0,  0, -8,   8,   8,  -8,   8, -8];
% cent_x=[0, -6,   6, -11, 11,  6,  -6,  17, -17];
% cent_y=[0, -9,   9,   0,  0, -9,   9,   9,  -9];
cent_x=[0, -20,  20];
cent_y=[0, -10, -10];
% cent_x=[0, -19,  19];
% cent_y=[0, -10, -10];
...
% cent_x=[0, -6,  14];
% cent_y=[0, -14, -6];
% cent_x=[0, -18,  18, 18, -18, 0];
% cent_y=[0, -10, -10, 10,  10, 18];
