...
y_t_space=10.54*m;%*1.1*.8;%*1.4;%13.5;%10.54; % spacing of tiling along y-axis
x_t_space=14*m;%*1.1*.8;%*1.4;%14.4;%12;%10; % spacing of tiling along x-axis
