...
if limited_fields
    p1=20;%.68;
    p2=2;p3=2;
    p4=15*1;%*1.4;%*2;%8; % center size
    p5=p3;p6=p4;
    p7=0.12475*1.2;%*1.4;%*2;%0.20; % surround size
    p8=30;%.135;
    p9=2;p10=2;p11=2;p12=p4;p13=p11;p14=p11;p15=p12;
    p16=1.08*1.1;%*2; % surround size
    p17=0.0058;
...
y_t_space=10.54*1.1;%*1.4;%13.5;%10.54; % spacing of tiling along y-axis
x_t_space=14*1.1;%*1.4;%14.4;%12;%10; % spacing of tiling along x-axis
...
% rotations
a=0;%15;%0;%15;%10;%90-18.435;%90-18; % angle of movement
...
function [centx, centy]=init_hex(centx,centy,center_x,center_y,x_t_space,y_t_space,s_mult,fields_number)
    ...
    if fields_number >= 1
        ...
        centx=[centx, center_x+(x_t_space*m*2.7)];
        centy=[centy, center_y]; 
    end        
    if fields_number >= 3
