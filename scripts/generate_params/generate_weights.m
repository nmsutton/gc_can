...
start_x_shift = (grid_size/2) - 20;%50;%44;%- 44;%1;%28; -2 = 2 down
start_y_shift = (grid_size/2) - 20;%50;%44;%- 44;%1;%-4;%28; +2 = 2 left
p1=.68;p2=2;p3=2;
p4=38*2.7*(14/20);%1.4;%*.5; % center size
p5=p3;p6=p4;
p7=0.174*2.4*(14/20);%1.4;%*.75;%0.15; % surround size
p8=.135;p9=2;p10=2;p11=2;p12=p4;p13=p11;p14=p11;p15=p12;
p16=0.9396*3*(14/20);%1.4;%*.75;%0.81; % surround size
p17=0.0058;
