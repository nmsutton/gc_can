...
% set run params
t_start = 29500;%800;%1;%800;%12400;%11400;%7000%12400;%8000;%10000;%5000; % start time
...
N=300;%49;%150;%49; % number of spikes to plot
X=[]; Y=[];
spike_marker_size=30;%15;%50;%5;%30;%5;
...
function [X,Y]=find_spikes(stel_nS, t_start, t_end, neuron_numbers, N, X, Y)
	for y=t_start:t_end
		for x2=1:N
			x=100+x2;%35+x2;%25+x2;%50+x2;%neuron_numbers(x2);
