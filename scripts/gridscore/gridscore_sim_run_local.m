...
if preloaded_spk_reader==0 && ~exist('keep_vars','var')
    clear all; preloaded_spk_reader=0;
end
clear keep_vars;
...
fdr_prefix="param_explore_tm_";%"gc_can_"; % folder name prefix for hopper run. "gc_can_" for main dir; "param_explore_iz_" for iz pe.
if ~exist('restrict_time','var')
restrict_time=80000;%6733000;%4328000;%1360000;%500000; % limit time plotted. 0 for no restriction; in 20ms bins
end
