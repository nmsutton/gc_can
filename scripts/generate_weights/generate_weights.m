...
if write_to_file
	...
	total_nrns_target = (grid_size_target^2);
	if total_nrns < total_nrns_target
		total_nrns_target = total_nrns;
	end
	for i=0:(total_nrns_target-1)
		...
		if i ~= (total_nrns_target-1)
			fprintf(output_file,'},\n{');
		end	
		if (mod(i,grid_size*3)==0)
			fprintf("%.3g%% completed\n",i/total_nrns_target*100);
		end
	end
	fprintf(output_file,'}};');
end
