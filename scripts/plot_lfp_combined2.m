...
Ne=1600*2;%1764; % ending index of principal cell spikes to plot
...
Randomize=0; % randomize order of neurons in each neuron type group
ShowLegend=1;
...
LFPmpyY=sum(SPKmpy,2);
LFPmpyY=LFPmpyY(500:2500)';

% plot
font_scale=18;
plot(LFPnrnX,[LFPsteY+LFPaxaY+LFPbasY+LFPbmuY+LFPmpyY],'-o','MarkerSize',1,'Color',[0.0 0.0, 0.0])
