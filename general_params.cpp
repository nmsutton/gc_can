...
struct P {
	...
	double speed_mult = 1.25;//0.6;//1.2;//1.5;//4.5;//7.5; // starting grid cell input speed level
	double mex_hat_multi = 1000;//5;//2.6;//1.2;//1.2;//400.0;//1.2;//1.2;//1.4; // mexican hat multiplier
	float gc_to_in_wt = 400.0; // gc to interneurons weight
	float dir_to_gc_wt = 28.0; // ext_dir to gc weight
