...
struct P {
	...
	double pos[2] = {22,7.75};//{30,18};//{9,17};//{22,8}; // virtual animal position tracker. starting position: {x,y}
	double bpos[2] = {22,7.75};//{9,17}; // bump position tracker
	...
	double speed_signaling = 0.3;//0.1;//0.1;//0.3;//0.1;//0.1;//0.1;//0.1;//0.5;//0.1;//0.1;//0.6;//1.5;//0.4;//2.0;//0.6;//2.0;//0.4;//5.0;//0.25;//0.1;//5.0;//0.1;//5.0;//5;//0.2;//1.6;//0.2;//0.05;//0.1;//0.05;//0.5;//20;//5;//0.5;//0.1;//0.1;//0.2;//5.0;//0.3;//2.0;//0.05;//1.8;//3.5;//0.0;//5.0;//0.0;//5.0;//0.3;//1.0;//1.0;//5.0;//5.0;//0.0;//5.0;//1.0;//0.5;//1.0;//0.1; // setting for use of a constant virtual animal speed
	float dir_to_gc_wt = 0.6;//1.2;//0.6;//0.3;//0.4;//0.3;//0.4;//0.4;//1.0;//0.4;//0.7;//0.5;//0.4;//1.0;//0.8;//2.0;//0.3;//0.5;//0.9;//0.75; ext_dir to gc weight
	double mex_hat_multi = 11.76*0.75;//0.75;//0.5;//.8;//0.5;//0.7;//0.3;//0.6;//1;//0.5;//1;//0.4;//0.5;//1;//1;//.65;//3;//3;//2;//2;//1;//2;//2;//0.75;//0.5;//1;//0.85;//2.5;//1.5;//*1.2;//1.05;//1.2;//1.17;//10.0;//20;//20;//30.0;//10;//1000;//700;//1100; // mexican hat multiplier
	float gc_to_in_wt = 0.370*0.75;//0.75;//0.5;//.8;//0.5;//0.7;//0.3;//0.6;//1;//0.5;//1;//0.4;//0.5;//1;//1;//.65;//3;//2;//2;//1;//1;//.8;//1;//3;//3;//1.5;//3;//2;//15;//1;//0.85;//2.5;//1.5;//*1.2;//1.05;//1.2;//1.17;//0.315;//0.3;//0.28;//0.5;//0.27;//0.2;//0.28;//0.30;//0.315;//0.297;//0.28;//0.28;//200;//50;//600; // gc to interneurons weight
	...
	double move_increment = 0.007;//0.018;//0.006;//0.005;//0.024;//0.018;//0.005;//0.018; // amount to move in position each move command
