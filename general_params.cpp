...
struct P {
	...
	double base_ext = 800;//16000.0;//1020.0;//2000.0;//1020.0;//34680;//1020.0;//30.0;//184//4.5;//800.0;//4.5; // baseline ext input speed level
	double speed_mult = 2;//0.6;//1.2;//1.5;//4.5;//7.5; // starting grid cell input speed level
	double mex_hat_multi = 200;//5;//2.6;//1.2;//1.2;//400.0;//1.2;//1.2;//1.4; // mexican hat multiplier
