...
struct P {
	double sim_time = 350000;//1440140;//8553860;//131400;//8485920;//120000//29416*20;//60000*firing_bin;// sim run time in ms
	...
	double pos[2] = {26.5,12.5};//{30,20};//{22,7.75};//{30,18};//{9,17};//{22,8}; // virtual animal position tracker. starting position: {x,y}
	double bpos[2] = {26.5,12.5};//{30,20};//{22,7.75};//{9,17}; // bump position tracker
	...
	float pc_to_gc_wt = 0.22;//0.3;//0.22;//1.0;//0.22;//0.2;//0.3;//0.2;//0.22;//0.25;//0.3;//0.3*0.48;//0.3;//0.3;//0.3;//0.4;//0.3;//0.4;//0.5;//0.4;//0.6;//1.0;//0.3;//0.6;//0.3;//0.6;//0.4;//0.3;//0.6;//0.4;//0.6;//0.3;//0.4;//0.6;//0.4;//0.4;//0.4;//0.4;//0.4;//0.4;//0.4;//1.0;//0.4;//1.0;//0.4;//0.4;//0.5;//0.4;//1.0;//3.0;//2.5;//2;//4;//5.5; // pc to gc synaptic weight
	double pc_sig = 2;//4;//2;//1.2;//2;//2;//4;//2;//3;//3;//4;//2;//2;//1;//1.4;//1;//0.75; // sigma symbol; width of the place feild
	double pc_level = 220;//300;//220;//1000;//220;//200;//300;//200;//220;//250;//300;//300*0.48;//300;//300;//300;//400;//300;//400;//500;//400;//600;//1000;//300;//600;//300;//600;//400;//300;//600;//400;//600;//300;//400;//600;//400;//400;//400;//1000;//2000;//400;//400;//2000;//400;//600;//700;//500;//3000;//3000;//2000;//2500;//3000; // place cell firing level
	...
	double grid_pattern_rot = -33.75;//-45;//0;//-45;//-22.5;//-45;//0;//15;//15;//-15; // angle value for rotation of grid pattern in plot
