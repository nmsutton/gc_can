...
struct P {
	...
	double dir_to_grc_g_fast = 33.082*1.1*.339;//.35;//.4;//.35;//.47;
	...
	float pc_to_grc_g_fast = 71.14*0.209;//0.2025;//0.220;//0.180;//0.4;//0.180;//0.155;//0.180;
	...
	double pc_level = 209.0;//202.5;//220;//180;//400;//180; // place cell firing level
