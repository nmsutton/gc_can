...
struct P {
	...
	double dir_to_grc_g_fast = 33.082*1.1*.36;//.43;//.5;//.25;//33.082*1.1*.58;//.62;//.65;//.3;//.65;//0.58;//.35;//.13;//.25;//.2;//.22;//.22;//.25;//.29;//.29;//.275;//.29;//.3;//.24;//.36;//.3;//.2;//.31;//*.25;//.47;//.6;//.8;//.6;//.35;//.22;//.6;//.35;//.13;//.15;//.35;//.4;//.35;//.47;
