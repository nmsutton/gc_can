...
struct P {
	...
	double base_ext = 250;//16000.0;//1020.0;//2000.0;//1020.0;//34680;//1020.0;//30.0;//184//4.5;//800.0;//4.5; // baseline ext input speed level	
	...
	float gc_to_in_wt = 600.0; // gc to interneurons weight
