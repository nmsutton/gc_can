...
struct P {
	...
	double sim_time = 100000;//131400;//120000//29416*20;//60000*firing_bin;// sim run time in ms
	int t = 0; // time
	...
	float gc_to_in_wt = 40;//9;//9;//20;//45;//14;//10;//1;//14;//9;//18.5;//9;//9.0;//7.5;//6.0;//11.5;//18.5;//13.5;//10;//8.5;//12;//5.5;//18.5;//16.5;//15.5;//13.5;//11.5;//5.5;//2.5;//1;//1;//0.45;//1;//25;//700.0; // gc to interneurons weight
