...
struct P {
	...
	double speed_mult = 2;//1.0;//35.0;//0.6;//1.2;//1.5;//4.5;//7.5; // starting grid cell input speed level
	float dir_to_gc_wt = 1.5;//1.5;//5.5; // ext_dir to gc weight
	double mex_hat_multi = 50;//30;//50;//800;//5;//2.6;//1.2;//1.2;//400.0;//1.2;//1.2;//1.4; // mexican hat multiplier
	float gc_to_in_wt = 5;//25;//700.0; // gc to interneurons weight
