...
struct P {
	...
	double speed_mult = 15.0;//0.6;//1.2;//1.5;//4.5;//7.5; // starting grid cell input speed level
	float dir_to_gc_wt = 6.5; // ext_dir to gc weight
	double mex_hat_multi = 900;//5;//2.6;//1.2;//1.2;//400.0;//1.2;//1.2;//1.4; // mexican hat multiplier
