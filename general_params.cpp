...
struct P {
	...
	double sim_time = 480*firing_bin;//120000//29416*20;//60000*firing_bin;// sim run time in ms
	int t = 0; // time
	...
	double const_speed = 1.8;//0.255;//0.195;//0.195;//0.5;//0.0;//0.195;//0.12; // setting for use of a constant virtual animal speed
