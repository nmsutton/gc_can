...
struct P {
	...
	double in_to_grc_g_fast = 0.6259622633;//11.76*0.8*7.63;//*(0.005537614433/0.00681312463724531);//1;
	double in_to_grc_g_slow = in_to_grc_g_fast*0.6120576671;
	...
	double move_increment = 0.009;//0.01;//0.018;//0.007;//0.018;//0.006;//0.005;//0.024;//0.018;//0.005;//0.018; // amount to move in position each move command
