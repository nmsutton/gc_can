...
struct P {
	double sim_time = 3000;//1440140;//8553860;//131400;//8485920;//120000//29416*20;//60000*firing_bin;// sim run time in ms
	...
	static const int EC_LII_Axo_Axonic_Count = 646;//534;//588;//300;
