...
struct P {
	...
	double sim_time = 300*firing_bin; // sim run time in ms
	int t = 0; // time
	...
	double base_ext = 325;//16000.0;//1020.0;//2000.0;//1020.0;//34680;//1020.0;//30.0;//184//4.5;//800.0;//4.5; // baseline ext input speed level
	double speed_mult = 1.06;//0.6;//1.2;//1.5;//4.5;//7.5; // starting grid cell input speed level
	double mex_hat_multi = 1610;//5;//2.6;//1.2;//1.2;//400.0;//1.2;//1.2;//1.4; // mexican hat multiplier
	float gc_to_in_wt = 445.0; // gc to interneurons weight
	float dir_to_gc_wt = 7.25; // ext_dir to gc weight
