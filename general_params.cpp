...
struct P {
	...
	static const int EC_LII_Axo_Axonic_Count = 1200;//646;//534;//588;//300;
	static const int MEC_LII_Basket_Count = 1200;//645;//533;//588;//300;
	static const int EC_LII_Basket_Multipolar_Count = 1200;//645;//533;//588;//300;
