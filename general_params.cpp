...
struct P {
	...
	double base_ext = 350;//16000.0;//1020.0;//2000.0;//1020.0;//34680;//1020.0;//30.0;//184//4.5;//800.0;//4.5; // baseline ext input speed level
	double speed_mult = 1;//1.2;//1.5;//4.5;//7.5; // starting grid cell input speed level
	double mex_hat_multi = 20;//5;//2.6;//1.2;//1.2;//400.0;//1.2;//1.2;//1.4; // mexican hat multiplier
	double dir_init_multi = 10000;//100000000;//10000;//1;//10000;
