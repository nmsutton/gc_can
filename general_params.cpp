...
struct P {
	double sim_time = 500000;//40000;//131400;//8485920;//120000//29416*20;//60000*firing_bin;// sim run time in ms
	...
	double move_increment = 0.002;//0.024;//0.018;//0.005;//0.018; // amount to move in position each move command
