...
struct P {
	...
	double sim_time = 20000*firing_bin; // sim run time in ms
	int t = 0; // time
	...
	double base_ext = 0;//800;//800;//300;//300;//300;//1100;//16000.0;//1020.0;//2000.0;//1020.0;//34680;//1020.0;//30.0;//184//4.5;//800.0;//4.5; // baseline ext input speed level	
	double const_speed = 0;//0.195;//0.12; // setting for use of a constant virtual animal speed
	double speed_mult = 0;//2;//10;//1.0;//35.0;//0.6;//1.2;//1.5;//4.5;//7.5; // starting grid cell input speed level
	float dir_to_gc_wt = 1.5;//1.6;//1.5;//1.5;//5.5; // ext_dir to gc weight
	...
	double move_increment = 0.55;//0.5312;//0.664;//0.665;//0.658;//0.64;//0.658;//0.1;//0.5;//0.2634;//0.325;//0.65; // amount to move in position each move command
	...
	float pc_to_gc_wt = 30;//0.5;//10; // pc to gc synaptic weight
