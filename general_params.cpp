...
struct P {
	...
	double base_ext = 800;//800;//400;//800;//400;//800;//500;//175;//300;//150;//300;//400;//270;//400;//600;//400;//400;//800;//600;//800;//800;//300;//300;//300;//1100;//16000.0;//1020.0;//2000.0;//1020.0;//34680;//1020.0;//30.0;//184//4.5;//800.0;//4.5; // baseline ext input speed level	
	double speed_signaling = 20;//5;//0.2;//5;//2;//.2;//0.02;//10;//0.1;//200.0;//0;//50.0;//0.8;//0.195;//1.8;//0.255;//1.8;//0.255;//0.195;//0.195;//0.5;//0.0;//0.195;//0.12; // setting for use of a constant virtual animal speed
	...
	double spdin2exwt = 1.0;//8.0;//3.0;//0.3;
	double spdex2inwt = 1.0;//0.3;
	double spdin2in_curr = 5.0;//0.0;//0.6;//0.15;//100;//0.0;
	double spdin2ex_curr = 4.0;//4;//0.5;//0.4;
	double spdex2in_curr = 0.0;//1.3;//0.0;//1.0;//50.0;//0.6;//0.6;//0;//1.0;
