...
struct P {
	...
	double move_increment = 0.027;//0.01;//0.018;//0.007;//0.018;//0.006;//0.005;//0.024;//0.018;//0.005;//0.018; // amount to move in position each move command
	...
	bool print_in_conn_stats = 0; // print statistics about interneuron connections
	vector<double> in_conns; // count of interneuron connections
